...
clustername=slbBilling # можно использовать номер порта, если кластен не именной, или именя базы кластера.
walbackup_dir=/pgbackup/$clustername/walbackup/
basebackup_dir=/pgbackup/$clustername/basebackup/
basebackup_cloud_dir=/mnt/ru0222nas02_YANDEX/ru0222app53/SQLBackup/$clustername/
# ///////////////////////////////////////////////////////////////
