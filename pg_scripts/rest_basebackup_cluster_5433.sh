...
$(dirname ${BASH_SOURCE[0]})/main/rest_basebackup.sh $PORT $PG_SETUP_NAME $PATH_PG_DATA $PATH_TO_FILE_BASEBACKUP $PATH_TO_FILES_BACKUP_WAL $ARCHIVE_MODE "$RECOVERY_TARGET"
