#!/bin/bash
#
# RGS Стартер модуль регламента basebackup и wal файлов кластера для оформления каталога и копирования в "облaко".
#
...
clustername=5433 # можно использовать номер порта, если кластен не именной, или именя базы кластера.
...
basebackup_cloud_dir=/mnt/ru0149bck01_SQLBackups/ru0149app149/SQLBackup/$clustername
# ///////////////////////////////////////////////////////////////
